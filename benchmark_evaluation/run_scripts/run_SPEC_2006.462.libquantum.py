...
bench_mark_name = 'SPEC_2006.462.libquantum'
script_path = os.path.dirname(os.path.realpath(__file__))
shell_script = os.path.join(script_path, 'run_SPEC_2006.462.libquantum.sh')
output_file_path = 'run_SPEC_2006.462.libquantum.out'
