...
OPT="$OPT_PATH/opt"
# clang options
FRONTEND_OPTS=" -c -g -O -m32 -ILLVM_BIN=$SASI_ROOT/si_eval/spec_benchmarks/hmmer-3.1b2-linux-intel-x86_64/easel -ILLVM_BIN=$SASI_ROOT/si_eval/spec_benchmarks/hmmer-3.1b2-linux-intel-x86_64/src -ILLVM_BIN=$SASI_ROOT/si_eval/spec_benchmarks/hmmer-3.1b2-linux-intel-x86_64/include"
