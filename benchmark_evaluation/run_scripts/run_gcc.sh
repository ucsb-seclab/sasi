...
OPT="$OPT_PATH/opt"
# clang options
FRONTEND_OPTS=" -c -g -O -m32 -ILLVM_BIN=$SASI_ROOT/si_eval/spec_benchmarks/gcc-6.1.0/include -ILLVM_BIN=$SASI_ROOT/si_eval/spec_benchmarks/gcc-6.1.0/host-x86_64-pc-linux-gnu/gcc -ILLVM_BIN=$SASI_ROOT/si_eval/spec_benchmarks/gcc-6.1.0/gcc -ILLVM_BIN=$SASI_ROOT/si_eval/spec_benchmarks/gcc-6.1.0/gcc/ginclude -ILLVM_BIN=$SASI_ROOT/si_eval/spec_benchmarks/gcc-6.1.0/gcc/config"
