...
OPT="$OPT_PATH/opt"
# clang options
FRONTEND_OPTS=" -c -g -O -m32 -ILLVM_BIN=$SASI_ROOT/si_eval/spec_benchmarks/JM/lcommon/inc -ILLVM_BIN=$SASI_ROOT/si_eval/spec_benchmarks/JM/ldecod/inc -ILLVM_BIN=$SASI_ROOT/si_eval/spec_benchmarks/JM/lencod/inc -ILLVM_BIN=$SASI_ROOT/si_eval/spec_benchmarks/JM/rtpdump"
