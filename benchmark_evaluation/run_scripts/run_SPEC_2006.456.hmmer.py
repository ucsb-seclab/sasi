...
bench_dir = sys.argv[1] + '/src'
bench_mark_name = 'SPEC_2006.456.hmmer'
script_path = os.path.dirname(os.path.realpath(__file__))
shell_script = os.path.join(script_path, 'run_SPEC_2006.456.hmmer.sh')
output_file_path = 'run_SPEC_2006.456.hmmer.out'
